...
if ($id === 0) {
    echo "<div class='container mx-auto px-4 py-20 text-center'><h1 class='text-2xl text-space-indigo font-bold'>Article not found.</h1><a href='/niloy/index.php' class='text-dusty-grape hover:underline mt-4 inline-block'>Return Home</a></div>";
...
<div class="bg-parchment py-8 px-4 border-b border-almond-silk fade-in">
    <div class="container mx-auto max-w-4xl">
        <div class="mb-4">
            <a href="javascript:history.back()" class="inline-flex items-center text-dusty-grape hover:text-space-indigo text-sm font-medium transition-colors">
        ...
        <div class="flex items-center justify-between border-t border-almond-silk pt-4">
            <div class="flex items-center text-dusty-grape text-sm font-medium space-x-4">
                ...
                <span id="articleReadCount" title="Total reads" class="flex items-center transition-all bg-almond-silk px-2 py-1 rounded-md text-space-indigo">
            ...
            <div class="flex space-x-2">
                <button class="w-8 h-8 rounded-full bg-almond-silk text-space-indigo flex items-center justify-center hover:bg-dusty-grape hover:text-parchment transition-colors" title="Share on Twitter" aria-label="Share on Twitter">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg>
                </button>
                <button class="w-8 h-8 rounded-full bg-almond-silk text-space-indigo flex items-center justify-center hover:bg-dusty-grape hover:text-parchment transition-colors" title="Share on Facebook" aria-label="Share on Facebook">
            ...
            <article class="lg:w-2/3 fade-in">
                <?php if($article['image']): ?>
                    <div class="mb-10 rounded-xl overflow-hidden shadow-md max-h-[500px]">
                        <img src="/niloy/uploads/<?php echo htmlspecialchars($article['image']); ?>" alt="Article Image" class="w-full h-full object-cover">
                    </div>
                <?php endif; ?>
                ...
                <div class="prose prose-lg max-w-none text-space-indigo">
                    ...
                    <!-- What Happened -->
                    <h2 class="text-2xl font-bold text-space-indigo mt-8 mb-4 border-b border-almond-silk pb-2">What Happened?</h2>
