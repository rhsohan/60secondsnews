...
<footer class="bg-space-indigo text-parchment py-8 mt-12">
    <div class="container mx-auto px-4 text-center">
        <p class="mb-4 text-lg font-semibold tracking-wide">60 Seconds News</p>
        <p class="text-sm text-lilac-ash max-w-2xl mx-auto mb-6">
            Understand the full story in just 60 seconds. Our goal is to eliminate clickbait and respect readers' time.
        </p>
